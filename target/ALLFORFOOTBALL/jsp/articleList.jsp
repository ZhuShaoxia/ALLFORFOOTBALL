            ...
            <ul class="nav nav-pills nav-justified">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="#"><img class="article-li-img" src="${pageContext.request.contextPath}/img/club/spanish/fcb_club.png" alt="">广州恒大</a>
                        </li>
                        <li><a href="#"><img class="article-li-img" src="${pageContext.request.contextPath}/img/club/spanish/fcb_club.png" alt="">上海上港</a>
                        </li>
                        <li><a href="#"><img class="article-li-img" src="${pageContext.request.contextPath}/img/club/spanish/fcb_club.png" alt="">山东鲁能</a>
                        </li>
                        <li><a href="#"><img class="article-li-img" src="${pageContext.request.contextPath}/img/club/spanish/fcb_club.png" alt="">北京国安</a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="#"><img class="article-li-img" src="${pageContext.request.contextPath}/img/club/spanish/fcb_club.png" alt="">巴塞罗那</a>
                        </li>
                        <li><a href="#"><img class="article-li-img" src="${pageContext.request.contextPath}/img/club/spanish/fcb_club.png" alt="">皇家马德里</a>
                        </li>
                        <li><a href="#"><img class="article-li-img" src="${pageContext.request.contextPath}/img/club/spanish/fcb_club.png" alt="">马德里竞技</a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="#"><img class="article-li-img" src="${pageContext.request.contextPath}/img/club/spanish/fcb_club.png" alt="">曼彻斯特城</a>
                        </li>
                        <li><a href="#"><img class="article-li-img" src="${pageContext.request.contextPath}/img/club/spanish/fcb_club.png" alt="">曼彻斯特联</a>
                        </li>
                        <li><a href="#"><img class="article-li-img" src="${pageContext.request.contextPath}/img/club/spanish/fcb_club.png" alt="">切尔西</a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown">
            ...
            <div class="hot-comment-list">
                <div class="hot-comment-item">
                    <div class="col-md-3 hot-comment-item-img">
                        <span>1</span>
                        <a href="#用户">
                            <img src="${pageContext.request.contextPath}/img/head-img-icon.png" alt="">
                        </a>
                    </div>
                    <a href="#文章">

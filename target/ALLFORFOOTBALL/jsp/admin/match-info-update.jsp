            ...
            <form class="layui-form" action="" method="post">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline" style="margin-right: 0px">
                        ...
                        <div class="layui-input-inline">
                            <select id="matchTypeId" name="matchType.id" lay-search>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline" style="margin-right: 0px">
                        ...
                        <div class="layui-input-inline" style="margin-right: 0px">
                            <select name="homeClub.id" lay-search>
                                <option value="0"></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-select-inline">
                            <select name="awayClub.id" lay-search>
                                <option value="0"></option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input name="matchDate" type="text" class="layui-input" id="match-add-date" placeholder=" - ">
                        </div>
                    </div>
                </div>
                <%--按钮--%>

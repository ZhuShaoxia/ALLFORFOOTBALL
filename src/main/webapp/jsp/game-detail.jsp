        ...
        <div class="col-md-9">
            <div class="game-detail-info">
                <div class="col-md-3 col-md-offset-1 game-detail-info-left">
                    <a href="#球队">
                        <img class="img-rounded team-img" src="${pageContext.request.contextPath}/img/club/spanish/fcb_club.png" alt="">
                ...
                <div id="match-result" class="tab-pane fade in active">
                    ...
                    <div class="match-result-item">
                            ...
                            <table class="table table-striped">
                                ...
                                <tr class="active">
                                    <td style="width:45%;text-align: right;font-size: 18px">巴塞罗那<img
                                            class="td-icon-img"
                                            src="${pageContext.request.contextPath}/img/club/spanish/fcb_club.png"
                                            alt=""></td>
                            ...
                            <ul class="time-line">
                                <li class="cf">
                                    ...
                                    <div class="time-line-left">
                                        <p><img class="match-img" src="${pageContext.request.contextPath}/img/match-shang.png" alt="">Messi</p>
                                        <p><img class="match-img" src="${pageContext.request.contextPath}/img/match-xia.png" alt="">保利尼奥</p>
                                    </div>
                                </li>
                                <li class="cf">
                                    <span class="num">12</span>
                        ...
                        <div class="match-describe">
                            <span class="match-describe-text"><img src="${pageContext.request.contextPath}/img/match-result-icon-a.png" alt=""
                                                                   class="match-describe-img">进球</span>
                            <span class="match-describe-text"><img src="${pageContext.request.contextPath}/img/match-result-icon-b.png" alt=""
                                                                   class="match-describe-img">点球</span>
                            <span class="match-describe-text"><img src="${pageContext.request.contextPath}/img/match-result-icon-c.png" alt=""
                                                                   class="match-describe-img">点球未进</span>
                            <span class="match-describe-text"><img src="${pageContext.request.contextPath}/img/match-result-icon-d.png" alt=""
                                                                   class="match-describe-img">乌龙球</span>
                            <span class="match-describe-text"><img src="${pageContext.request.contextPath}/img/match-result-icon-e.png" alt=""
                        ...
                        <table class="table table-striped" style="margin-bottom: 0px">
                            ...
                            <tr>
                                ...
                                <td style="width: 20%;text-align: right">特尔施特根<img class="td-icon-img"
                                                                                   src="${pageContext.request.contextPath}/img/club/china/p_alan.jpg"
                                                                                   alt=""></td>
                                <td style="width: 10%"></td>
                                <td style="width: 20%"><img class="td-icon-img" src="${pageContext.request.contextPath}/img/club/china/p_alan.jpg" alt="">纳瓦斯
                                </td>
                                <td style="width: 15%;text-align: center">守门员</td>
                                <td style="width: 10%;text-align: center">1</td>
                            </tr>
            ...
            <div class="recent-game-body">
                <table class="table table-hover" style="text-align: center">
                    <tr>
                        <td>
                            <a href="#球队">
                                <p><img class="td-club-img" src="${pageContext.request.contextPath}/img/club/china/zc_shanggang.png" alt=""></p>
                                <p>上海上港</p>
                            </a>
                        </td>
                        ...
                        <td>
                            <a href="#球队">
                                <p><img class="td-club-img" src="${pageContext.request.contextPath}/img/club/spanish/fcb_club.png" alt=""></p>
                                <p>巴塞罗那</p>
                            </a>
                        </td>
                    </tr>

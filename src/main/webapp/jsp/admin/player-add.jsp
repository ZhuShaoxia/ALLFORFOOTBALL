            ...
            <form class="layui-form" action="" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input id="dribbling" type="number" name="dribbling" lay-verify="required|maxLength"
                                   autocomplete="off"
                                   class="layui-input" placeholder="请输入(最大100)">
                        </div>
                    </div>
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input id="defensive" type="number" name="defensive" lay-verify="required|maxLength"
                                   autocomplete="off"
                                   class="layui-input" placeholder="请输入(最大100)">
                        </div>
                    </div>

    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px">
            <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
                <legend>球员荣誉信息录入</legend>
            </fieldset>
            <form class="layui-form" action="">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <label for="clubId" class="layui-form-label">球员选择</label>
                        ...
                        <div class="layui-input-inline">
                            <select id="playerId" name="player.id" lay-search lay-filter="playerSelect"
                                    lay-verify="required">
                                <option value=""></option>
                            </select>
                        </div>
                ...
                <div class="layui-form-item" style="padding: 20px;text-align: center">
                    <div class="layui-input-block">
                        <button class="layui-btn" lay-submit lay-filter="player-honer-add">添加</button>
                ...
                <div class="">
                    <table class="layui-table">
                        ...
                        <tbody id="player-honer-tbody">
                            <c:forEach items="${honers}" var="honer">
                                <tr>
                                    <td>${honer.player.name}</td>

                            ...
                            <td style="width: 20% ;text-align: right">
                                <a href="#球队">
                                    <span class="schedule-club-name">上海上港</span><img
                                        class="td-icon-img" src="img/club/china/zc_shanggang.png" alt="">
                                </a>
                            </td>
                            <td style="width: 3%;">VS</td>
                            <td style="width: 20% ;text-align: left">
                                <a href="#球队"><img class="td-icon-img"
                                                   src="img/club/china/zc_shanggang.png" alt=""><span
                ...
                <div class="club-member-body">
                    <table class="table table-hover table-striped" style="text-align: center">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#球员">
                                    <img class="td-icon-img" src="img/club/china/p_alan.jpg" alt="">卡纳瓦罗
                                </a>
                            </td>
                            <td>--</td>
                            <td>--</td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#球员">
                                    <img class="td-icon-img" src="img/club/china/p_alan.jpg" alt="">阿兰
                                </a>
                            </td>
                            <td>20</td>
                            <td>9</td>
    ...
    <div class="col-md-3" style="padding-right:0px">
        <div>
            <table class="table table-hover">
                ...
                <tr class="active">
                    <td>1</td>
                    <td><a href="club.jsp"><img class="td-icon-img" src="img/club/china/zc_shanggang.png">上海上港</a>
                    </td>
                    <td>2/2/2</td>
                    <td>6</td>
                </tr>

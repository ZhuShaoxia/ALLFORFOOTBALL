 ...
 * @Date: 2018/4/3
 * @Time: 12:20
 * Description:阿里短信下发接口
 */
public class AaliSMSUtil {
    ...
    static final String accessKeyId = "LTAI3ouzXFvTJDvh";
    static final String accessKeySecret = "pHczpggmgiObsMg4wJGNpGpzoUrz1y";
    ...
    public static SendSmsResponse sendSms() throws ClientException {
        ...
        //必填:待发送手机号
        request.setPhoneNumbers("15211054977");
        //必填:短信签名-可在短信控制台中找到
    ...
    public static SendSmsResponse sendSms(User user, String code) throws ClientException {
        //可自助调整超时时间
        System.setProperty("sun.net.client.defaultConnectTimeout", "10000");
        System.setProperty("sun.net.client.defaultReadTimeout", "10000");
